...
gpt_options=" \
       --experiment-name cogview-hwc-36-4096-64 \
       ...
       --train-iters 80000 \
       --resume-dataloader \
       --train-data $main_dir/data/t2i_base_32.lmdb $main_dir/data/i2t_base_32.lmdb \
       --split 949,50,1 \
       ...
       --fp16 \
       --save-interval 2000 \
       --new-dataset-path $main_dir/data/new_datasets \
"
    #    --query-window 128 \
    #    --key-window-times 6 \
    #    --num-pivot 768 \
