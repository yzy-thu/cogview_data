...
def add_generate_args(parser):
    ...
    group = parser.add_argument_group('Generation', 'configurations')
    group.add_argument("--generate_type", type=str, default="text2img")
...
def add_sparse_args(parser):
    ...
    group.add_argument('--is-sparse', type=int, default=0,
                       choices=[0, 1, 2],
                       help='whether use sparse attention. 0 not 1 train 2 inference')
...
def get_args():
    ...
    parser.add_argument('--world-rank', type=int, default=0,
                       help="""Number of workers to use for dataloading""")
